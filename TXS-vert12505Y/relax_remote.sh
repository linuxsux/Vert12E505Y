...
pmemd.cuda -O -i Relaxation/1min.in -o Relaxation/1min.out -p TXS-vert12.prmtop -c TXS-vert12.inpcrd -r Relaxation/1min.rst7 -inf Relaxation/1min.info -ref TXS-vert12.inpcrd -x Relaxation/mdcrd.1min

echo "ending 1min"

echo "starting 2mdheat"

pmemd.cuda -O -i Relaxation/2mdheat.in -o Relaxation/2mdheat.out -p TXS-vert12.prmtop -c Relaxation/1min.rst7 -r Relaxation/2mdheat.rst7 -inf Relaxation/2mdheat.info -ref Relaxation/1min.rst7 -x Relaxation/mdcrd.2mdheat
echo "ending 2mdheat"
